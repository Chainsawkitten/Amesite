...
Nest::Nest(Scene* scene) : SuperEnemy(scene) {
    mActiveGlowBody = Resources().CreateTexture2DFromFile("Resources/crystal_glow.png");
    ...
    body->GetComponent<Component::Material>()->SetDiffuse("Resources/crystal_diff.png");
    body->GetComponent<Component::Material>()->SetSpecular("Resources/crystal_spec.png");
