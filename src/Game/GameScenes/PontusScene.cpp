...
#include <Component/ParticleEmitter.hpp>
#include <Game/Component/AI/WalkerAI.hpp>
#include <Game/Component/AI/LookerAI.hpp>
...
PontusScene::PontusScene() {
    ...
    Entity* p = player1->GetEntity("body");
    Entity* p2 = player2->GetEntity("body");
    Component::WalkerAI* ai = p->AddComponent<Component::WalkerAI>();
    ai->AddPoint(glm::vec3(-5, 0, 0));
    ai->AddPoint(glm::vec3(0, 0, 10));
    ai->AddPoint(glm::vec3(5, 0, 10));
    ai->mSpeed = 50;
    Component::LookerAI* ai2 = p->AddComponent<Component::LookerAI>();
    ai2->AddEntity(p2);
    ai2->mDistance = 10;
    
    ai2 = p2->AddComponent<Component::LookerAI>();
    ai2->AddEntity(p);
    ai2->mDistance = 10;
...
void PontusScene::Update(float deltaTime) {
    // ControllerSystem
    mControllerSystem.Update(*this, deltaTime);

    mAISystem.Update(*this, deltaTime);
...
bool PontusScene::GridCollide(Entity* entity, float deltaTime) {
