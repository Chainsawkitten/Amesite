...
//        if (thisPlayer != otherPlayer) {
//            if (!thisPlayer->Active() && glm::distance(thisPlayer->GetPosition(), otherPlayer->GetPosition()) < 15) {
...
//    }
//    if (thisPlayer->mRespawnTimer < 0.001f) {
//        thisPlayer->GetNodeEntity()->GetComponent<Component::ParticleEmitter>()->enabled = false;
//        thisPlayer->Activate();
//    }
//
//    if (thisPlayer->Active()) {
//        thisPlayer->mRespawnTimer = 5;
//        thisPlayer->GetNodeEntity()->GetComponent<Component::ParticleEmitter>()->particleType.color = glm::vec3(0.01f, 0.01f, 0.01f);
//    }
//}
